...
export default function AdminActionCard({ url, title, description, icon, isDisabled }) {
  return (
    <Link href={url ? url : "#"} disabled={isDisabled ? "disabled" : ""}>
      <div className='group py-8 px-4 flex justify-between gap-2 items-center bg-gray-800 border border-gray-700 rounded-xl hover:bg-white/10 hover:ring-1 cursor-pointer hover:border-gray-600 transition'>
        <div>
